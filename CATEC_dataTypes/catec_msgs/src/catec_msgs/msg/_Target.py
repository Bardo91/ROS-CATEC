"""autogenerated by genpy from catec_msgs/Target.msg. Do not edit."""
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_B3d.pack(_x.target, _x.position.x, _x.position.y, _x.position.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.target, _x.position.x, _x.position.y, _x.position.z,) = _struct_B3d.unpack(str[start:end])
      return self
