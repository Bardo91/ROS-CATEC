"""autogenerated by genpy from catec_actions_msgs/LandActionFeedback.msg. Do not edit."""
import sys
...
class LandActionFeedback(genpy.Message):
  _md5sum = "256dea1099e87c9e140617afb66894b1"
  _type = "catec_actions_msgs/LandActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','catec_actions_msgs/LandFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LandActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = catec_actions_msgs.msg.LandFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = catec_actions_msgs.msg.LandFeedback()
