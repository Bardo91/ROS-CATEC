"""autogenerated by genpy from catec_actions_msgs/AALExtensionActionActionFeedback.msg. Do not edit."""
import sys
...
class AALExtensionActionActionFeedback(genpy.Message):
  _md5sum = "d31badb93cf1e4639611f74647faaa49"
  _type = "catec_actions_msgs/AALExtensionActionActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','catec_actions_msgs/AALExtensionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AALExtensionActionActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = catec_actions_msgs.msg.AALExtensionActionFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = catec_actions_msgs.msg.AALExtensionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.feedback.phase))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.phase,) = _struct_B.unpack(str[start:end])
      return self
