"""autogenerated by genpy from catec_actions_msgs/PathActionFeedback.msg. Do not edit."""
import sys
...
class PathActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "catec_actions_msgs/PathActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','catec_actions_msgs/PathFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PathActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = catec_actions_msgs.msg.PathFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = catec_actions_msgs.msg.PathFeedback()
