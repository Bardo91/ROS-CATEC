"""autogenerated by genpy from catec_actions_msgs/BatteryRechargeAction.msg. Do not edit."""
import sys
...
class BatteryRechargeAction(genpy.Message):
  _md5sum = "6f35ff2f019f00e83a8a2a8b6f46d4c7"
  _type = "catec_actions_msgs/BatteryRechargeAction"
...
"""
  ...
  _slot_types = ['catec_actions_msgs/BatteryRechargeActionGoal','catec_actions_msgs/BatteryRechargeActionResult','catec_actions_msgs/BatteryRechargeActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BatteryRechargeAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = catec_actions_msgs.msg.BatteryRechargeActionGoal()
      if self.action_result is None:
        self.action_result = catec_actions_msgs.msg.BatteryRechargeActionResult()
      if self.action_feedback is None:
        self.action_feedback = catec_actions_msgs.msg.BatteryRechargeActionFeedback()
    else:
      self.action_goal = catec_actions_msgs.msg.BatteryRechargeActionGoal()
      self.action_result = catec_actions_msgs.msg.BatteryRechargeActionResult()
      self.action_feedback = catec_actions_msgs.msg.BatteryRechargeActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_4I.pack(_x.action_result.result.battery_level, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_result.result.battery_level, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
