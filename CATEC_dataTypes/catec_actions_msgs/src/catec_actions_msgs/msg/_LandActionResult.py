"""autogenerated by genpy from catec_actions_msgs/LandActionResult.msg. Do not edit."""
import sys
...
class LandActionResult(genpy.Message):
  _md5sum = "e51d725f4cca06b033756ec0b44eab05"
  _type = "catec_actions_msgs/LandActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','catec_actions_msgs/LandResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LandActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = catec_actions_msgs.msg.LandResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = catec_actions_msgs.msg.LandResult()
