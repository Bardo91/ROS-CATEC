"""autogenerated by genpy from catec_actions_msgs/PathAction.msg. Do not edit."""
import sys
...
class PathAction(genpy.Message):
  _md5sum = "d9b50ddbfb0089e233de5b21e0d4a4ba"
  _type = "catec_actions_msgs/PathAction"
...
"""
  ...
  _slot_types = ['catec_actions_msgs/PathActionGoal','catec_actions_msgs/PathActionResult','catec_actions_msgs/PathActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PathAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = catec_actions_msgs.msg.PathActionGoal()
      if self.action_result is None:
        self.action_result = catec_actions_msgs.msg.PathActionResult()
      if self.action_feedback is None:
        self.action_feedback = catec_actions_msgs.msg.PathActionFeedback()
    else:
      self.action_goal = catec_actions_msgs.msg.PathActionGoal()
      self.action_result = catec_actions_msgs.msg.PathActionResult()
      self.action_feedback = catec_actions_msgs.msg.PathActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_6d3I.pack(_x.action_goal.goal.initial_position.x, _x.action_goal.goal.initial_position.y, _x.action_goal.goal.initial_position.z, _x.action_goal.goal.final_position.x, _x.action_goal.goal.final_position.y, _x.action_goal.goal.final_position.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.action_result.result.path_length, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.initial_position.x, _x.action_goal.goal.initial_position.y, _x.action_goal.goal.initial_position.z, _x.action_goal.goal.final_position.x, _x.action_goal.goal.final_position.y, _x.action_goal.goal.final_position.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_6d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.path_length, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
