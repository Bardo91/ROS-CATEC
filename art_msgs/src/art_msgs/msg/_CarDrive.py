...
class CarDrive(genpy.Message):
  _md5sum = "5adf1d2537a1083aa457a802033ce417"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2d.pack(_x.speed, _x.steering_angle))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.speed, _x.steering_angle,) = _struct_2d.unpack(str[start:end])
      return self
